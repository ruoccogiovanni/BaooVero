...
public class RecyclerViewAdapterProva extends RecyclerView.Adapter<RecyclerViewAdapterProva.MyViewHolder> {

    private Context mContext ;
    private List<DogProva> mData ;


    public RecyclerViewAdapterProva(Context mContext, List<DogProva> mData) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        DogProva currentdog= mData.get(position);
